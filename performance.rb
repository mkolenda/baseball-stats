...
--triplecrown <year-league:year-league>, -t <year-league:year-league>
   ...
   separate combinations of years/leagues with a :. For example

   2008-AL:2009-NL:2010-AL:2011-NL
    ...
    when '--triplecrown'
      ...
      arg.split(/:/).each do |pair|
        ...
        unless r.empty?
          ...
          puts "No winner for year #{a[0]} and league #{a[1]}"
        end
      end
  end
end
